...
LINKLER = [
    ...
    # ── İlan Platformları
    # Mainz'e özel ilan linkleri (scope='stadt' migration ile atanır)
    dict(ad='Kleinanzeigen — Mainz', url='https://www.kleinanzeigen.de/s-mainz/c0',
         kategori='ilan', sira=1,
         aciklama="Mainz bölgesi ücretsiz ilan platformu. Araç, ev, eşya alım-satım."),
    dict(ad='ImmobilienScout24 — Mainz', url='https://www.immobilienscout24.de/Suche/de/rheinland-pfalz/mainz/wohnung-mieten',
         kategori='ilan', sira=2,
         aciklama="Mainz'da kiralık ev ilanları."),
    dict(ad='Immonet — Mainz', url='https://www.immonet.de/immobiliensuche/mainz.html',
         kategori='ilan', sira=3,
         aciklama='Mainz kiralık ve satılık ev ilanları.'),
