...
class Yer(models.Model):
    ...
    maps_url        = models.URLField(max_length=500, blank=True, help_text='Google Maps linki')
    aciklama        = models.TextField(blank=True)
    kapak_resmi     = models.URLField(max_length=500, blank=True, verbose_name='Kapak Resmi URL (harici)')
